        ...
        >
            ...
            >
                ...
                <div className="flex items-center gap-1" onPointerDown={event => event.stopPropagation()}>
                    ...
                    >{t("extensions.debug.copy")}</Tooltip>
                    <Tooltip
                        trigger={<div>
                            <IconButton
                                intent="gray-basic"
                    ...
                    >{t("extensions.debug.clear")}</Tooltip>
                    <Tooltip
                        trigger={<div>
                            <IconButton
                                intent="gray-basic"
                    ...
                    >{t("extensions.debug.close")}</Tooltip>
                </div>
            </div>
            <div className="flex flex-col gap-2 border-b border-[--border] px-3 py-2 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex min-w-0 flex-1 items-center gap-2">
                    <TextInput
                        ...
                        placeholder={t("extensions.debug.searchPlaceholder")}
                        size="sm"
                ...
                <div className="flex min-w-0 items-center gap-1 overflow-x-auto">
                    {dbgLvls.map(item => (
                        ...
                        >
                            {t(`extensions.debug.levels.${item}`)}
                        </button>
                    ))}
                </div>
