            ...
            >
                ...
                <div className="space-y-2">
                    ...
                    {serverStatus?.isDesktopSidecar && <Alert
                        intent="info"
                        description={t("update.desktopApplicationDescription")}
                    />}
                    ...
                    <div className="flex gap-2 w-full items-center !mt-4">
                        {!serverStatus?.isDesktopSidecar && <Modal
                            ...
                            title={<span>{t("update.installModalTitle")}</span>}
                        >
                        ...
                        {!serverStatus?.isDesktopSidecar &&
                            <Button intent="white" leftIcon={<BiDownload />} onClick={() => setDownloaderOpen(true)}>{t("common.buttons.download")}</Button>}
                    </div>
                </div>
            </Modal>
        </>
...
export function Downloader(props: DownloaderProps) {
    ...
    return (
        <Modal
            ...
            title={t("update.downloadNewReleaseTitle")}
        ...
        >
            ...
            <div className="flex gap-2 justify-end mt-2">
                <Button intent="white" leftIcon={<BiDownload />} onClick={handleDownloadRelease} loading={isPending}>{t("common.buttons.download")}</Button>
            </div>
        </Modal>
    )
}
