...
export function IssueReport() {
    ...
    async function downloadIssueReport() {
        ...
        if (password && !tokenQuery) {
            throw new Error(t("toasts.issueReport.downloadTokenFailed"))
        }
        ...
        if (!response.ok) {
            let message = t("toasts.issueReport.downloadFailed")
            try {
                    ...
                    {!isRecording ? <div className="space-y-3 min-w-[280px]">
                        ...
                        <div className="flex items-center gap-2 pt-1 border-t border-gray-800">
                            ...
                            >
                                ...
                                {isPending || isDownloadingReport ? t("issueReport.actions.saving") : t("issueReport.actions.stopAndSave")}
                            </button>
                            <Tooltip
                                trigger={<IconButton
                                    intent="gray-basic"
