...
export function DenshiSettings() {
    ...
    return (
        <div className="space-y-4">
            <SettingsCard title={t("settings.common.window")}>
                <Switch
                    side="right"
            ...
            <SettingsCard title={t("settings.common.system")}>
                <Switch
                    side="right"
                    ...
                    help={window.electron?.platform === "linux"
                        ? t("settings.denshi.openAtLaunchLinuxUnsupported")
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500 bg-gray-50 dark:bg-gray-900/30 rounded-lg p-3 border border-gray-200 dark:border-gray-800 border-dashed">
                ...
                <span>{t("settings.common.savedAutomaticallyAfterRestart")}</span>
            </div>
        </div>
    )
}
